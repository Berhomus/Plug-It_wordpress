...
?>
<form method="post" enctype="multipart/form-data" action="<?php echo $_SESSION['protocol'].$_SESSION['current_loc']; ?>traitement/trt_ref.php?mode=<?php echo $type; ?>">	
	<table border="0" cellspacing="20" cellpadding="5" style="margin:auto; margin-top:30px;">							
		...
		<tr style="height:40px;">				
			<td><label for="logo"><b>Logo du client <span class="red">*</span></b><br/><small>(Max 100Ko et uniquement jpg, png, gif et bmp)<br/>(Taille conseillée 220x161)</small></label></td>				<td><input size="50" type="file" name="logo" id="logo" <?php echo $require; ?>/></td>			
		</tr>						
